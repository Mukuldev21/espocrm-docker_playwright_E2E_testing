...
test.describe('Accounts Module', () => {
  ...
  test('TC010: Delete Account', { tag: ['@parentSuite:EspoCRM_E2E_Tests', '@suite:Accounts_Module', '@severity:critical', '@TC010'] }, async ({ Given, When, Then, And, page }) => { 
    await Given('I am on the dashboard', null, { page }); 
    await When('I click on the "Accounts" menu item', null, { page }); 
    await And('I click the "Create Account" button', null, { page }); 
    await And('I enter unique account details', null, { page }); 
    await And('I click the "Save" button', null, { page }); 
    await Then('I should see the newly created account', null, { page }); 
    await When('I delete the created account', null, { page }); 
    await Then('I should not see the account in the list', null, { page }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":36,"pickleLine":35,"tags":["@parentSuite:EspoCRM_E2E_Tests","@suite:Accounts_Module","@severity:critical","@TC010"],"steps":[{"pwStepLine":37,"gherkinStepLine":36,"keywordType":"Context","textWithKeyword":"Given I am on the dashboard","stepMatchArguments":[]},{"pwStepLine":38,"gherkinStepLine":37,"keywordType":"Action","textWithKeyword":"When I click on the \"Accounts\" menu item","stepMatchArguments":[{"group":{"start":15,"value":"\"Accounts\"","children":[{"start":16,"value":"Accounts","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":39,"gherkinStepLine":38,"keywordType":"Action","textWithKeyword":"And I click the \"Create Account\" button","stepMatchArguments":[]},{"pwStepLine":40,"gherkinStepLine":39,"keywordType":"Action","textWithKeyword":"And I enter unique account details","stepMatchArguments":[]},{"pwStepLine":41,"gherkinStepLine":40,"keywordType":"Action","textWithKeyword":"And I click the \"Save\" button","stepMatchArguments":[]},{"pwStepLine":42,"gherkinStepLine":41,"keywordType":"Outcome","textWithKeyword":"Then I should see the newly created account","stepMatchArguments":[]},{"pwStepLine":43,"gherkinStepLine":42,"keywordType":"Action","textWithKeyword":"When I delete the created account","stepMatchArguments":[]},{"pwStepLine":44,"gherkinStepLine":43,"keywordType":"Outcome","textWithKeyword":"Then I should not see the account in the list","stepMatchArguments":[]}]},
]; // bdd-data-end